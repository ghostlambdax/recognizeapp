class Api::V2::Endpoints::Auth::Login < Api::V2::Endpoints::Auth
  resource :auth, desc: '' do
    ...
    params do
      ...
      optional :client_secret, type: String, description: "Required for confidential applications (eg non-mobile)"
      requires :email, type: String
      requires :password, type: String
      optional :scope, type: String, description: "Default is: 'profile read write' (space separated). Company scopes must be explicitly specified and available from your application."
    ...
    post '/' do
      ...
      present token, include_token: true
    end    
  end
end
