...
Recognize.Post = (function() {
  ...
  Post.prototype.recognitionId = function() {
    ...
    return regexp.exec(this.container.find(".yj-media-card--title-link").prop('href'))[1];
  };
  ...
  Post.prototype.isRecognition = function() {
    return this.container.find(".yj-media-card--title-link[href*='recognizeapp']").length > 0;
  };
