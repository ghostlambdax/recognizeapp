...
R.Transition = (function() {
  ...
  Transition.prototype.fadeTop = function(element) {
    ...
    if (element) {
      $body.append($("<div id='shadow' onclick='R.transition.fadeTop()' style='height: 100%; width: 100%; position: fixed; top: 0; left: 0; z-index: 1000; background: black; opacity: 0.7'>"));
