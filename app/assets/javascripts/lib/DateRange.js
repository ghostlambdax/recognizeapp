...
window.R.DateRange = (function ($, window, body, undefined) {
  ...
  D.prototype.addEvents = function() {
    ...
    $document.on("turbolinks:request-start", this.removeEvents.bind(this));
  };
  ...
  D.prototype.removeEvents = function() {
    ...
    $document.off("turbolinks:request-start", this.removeEvents.bind(this));
  };
  ...
  D.prototype.formatDate = function(date) {
