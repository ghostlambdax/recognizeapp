  ...
  I.prototype.appendYammerUsers = function(userList) {
    ...
    for (var user in userList) {
      if (userList.hasOwnProperty(user)) {
        compiledYammerUsers.push("<div class=person data-id="+user+"><i data-feather='check' color='white' height='15'></i><img src="+userList[user].img + "/><h4>" + userList[user].name + "</h4></div>");
      }
    }
