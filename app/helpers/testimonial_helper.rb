module TestimonialHelper
  def testimonial_html(testimonial_index = nil)
    if testimonial_index.present?
  ...
  TESTIMONIALS = [{
                  ...
                  {
                    quote: "Recognize is a great tool for us to decide the winner of our top employee of the month contest.",
                  ...
                  {
                    quote: "Recognize helped our staff use Yammer more through the badging.",
                    title: "Leonardo Nogueira, CEO",
                    company: "Prosperi",
                    img: avatar_path("leonardo.jpg")
                  },
                  {
                    quote: "I just wanted to say Thank You for the RecognizeApp Program. So far, it has already been a big hit in our company and culture and I think we are getting great activity. I appreciate the program and the help of you and your team in helping us get it launched.",
                    title: "Brent Estes, VP",
                    company: "Century Lighting & Electric",
                    img: avatar_path("brent.jpg")
                  }
  ]
  def testimonials
    TESTIMONIALS
